...
# model_path = "".join([filepath, 'bike_', datetime, '_', filename])
...
#                       filepath = model_path)
# start = time.time()
# hist = model.fit(x_train, y_train, epochs=1000, batch_size = 50, validation_split = 0.1, callbacks = [es,mcp])
# end = time.time()- start

# print("걸린시간 : ", round(end, 3), '초')
model = load_model('./_ModelCheckPoint/bike_1206_2356_0105-1.3985.hdf5')
