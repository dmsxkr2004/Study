...
print("결과 : ", min_dict)
'''
결과 :  {'target': 0.08967543772411164, # 100개 결과치
'''


# 결과 :  {'target': 0.08880731990832653, 'params': {'colsample_bytree': 0.6256122030542259,
#                                                  'learning_rate': 0.02946686273489884,
#                                                  'max_depth': 5.19502674696493,
#                                                  'min_child_weight': 1.0559217266984282,
#                                                  'n_estimators': 6847.522336362754,
#                                                  'reg_lamda': 2.801324115605266,
#                                                  'subsample': 0.5881976138341406}
#        }