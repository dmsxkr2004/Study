...
#2. 모델 구성
model = HalvingGridSearchCV(XGBRegressor(), parameters, cv = kfold, verbose = 3,
                     refit=True, n_jobs=1)
...
'''
최적의 매개 변수 : RandomForestRegressor(max_depth=6)
최적의 파라미터 :  {'max_depth': 6, 'n_estimators': 100}
best_score_ : 0.8526361072314206
소요 시간 : 18.311999082565308
...
best_score_ : 0.8441892807797992
소요 시간 : 9.44270372390747
'''