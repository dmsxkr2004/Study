...
from sklearn.model_selection import train_test_split, RandomizedSearchCV, HalvingGridSearchCV # 랜덤 = 랜덤하게 추출해서 돌려봄 , 하빙 = 데이터의 일부만 돌려보고 최적의 데이터를 추출해서씀
