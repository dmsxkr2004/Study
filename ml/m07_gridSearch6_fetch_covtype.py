...
# 파라미터 조합으로 2개이상 엮을것
model = GridSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=1, # CV = cross validation
                     refit = True)
...
best_score_ :  0.93843062522292
model.score :  0.9444850821407365
accuacy_score :  0.9444850821407365
최적 튠 ACC :  0.9444850821407365
걸린시간 :  7063.105817079544
'''