...
parameters = [
    {"C":[1, 10, 100, 1000], "kernel":["linear"], "degree":[3,4,5]},    # 12 [1, 10, 100, 1000]<- 4 x [3,4,5] <-3 = 12 # 인덱스 갯수 따라 숫자 곱
    {"C":[1, 10, 100], "kernel":["rbf"], "gamma":[0.001,0.0001]},       # 6  # 3x2 = 6
    {"C":[1, 10, 100, 1000], "kernel":["sigmoid"],
     "gamma":[0.01, 0.001, 0.0001], "degree":[3,4]}                     # 24 4 x 3 x 2 = 24
]                                                                       # 총 42개 12 + 6 + 24 = 42
#2. 모델구성
